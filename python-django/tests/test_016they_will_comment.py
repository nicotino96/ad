...
class WallAPICommentModelExistsTestCase(unittest.TestCase):
    ...
    def __expected_lines_content(self):
        ...
        return [
            ...
            {"line": "models.CharField(max_length=1900)", "found": False},
            {"line": "models.ForeignKey(Entry, on_delete=models.CASCADE)", "found": False}
        ]
