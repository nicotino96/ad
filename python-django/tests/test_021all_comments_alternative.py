...
class WallAPIAllCommentsEndpointTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file = open("test_021all_comments_alternative.json", "w")
    ...
    def __test_with_server_alive(self, block):
        def run_server():
            proc = subprocess.Popen("python manage.py testserver ../../tests/test_021all_comments_alternative.json --noinput", creationflags=subprocess.CREATE_NEW_PROCESS_GROUP, cwd=context.WALL_API_ROOT)
            time.sleep(4)
