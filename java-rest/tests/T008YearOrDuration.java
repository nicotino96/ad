...
public class T008YearOrDuration {
    ...
    public static void fetchCorrectResults() {
        ...
        try {
            ...
            String year = "1988";
            String duration = "148";
            ResultSet result = statement.executeQuery("SELECT id, title FROM TMovies WHERE year > " + year + " or duration < " + duration);
            while(result.next()) {
    ...
    public void testResultsOk() {
        ...
        try {
            ...
            Method method = cls.getDeclaredMethod("getResultsIssue8");
