...
public class T010GenreAndYearAndDuration {
    ...
    public static void fetchCorrectResults() {
        ...
        try {
            ...
            String year = "2010";
            String duration = "87";
            ResultSet result = statement.executeQuery("SELECT title, year FROM TMovies WHERE genre = 'comedy' and year < " + year + " and duration > " + duration);
    ...
    public void testResultsOk() {
        ...
        try {
            ...
            Method method = cls.getDeclaredMethod("getResultsIssue10");
